      ...
      <div className='bggimg w-screen h-screen pt-[100px]'>
        <div className='boxx w-[582px] h-[667px] backdrop-blur-2xl rounded-[11px]'>
          ...
          <form>
            ...
            <input className='w-[417px] h-[86px] mt-6 items-center text-center not-italic font-[400px] text-[16px] leading-[18px] border-2 bg-transparent mb-[28px]' type="password" id='password' placeholder='email password' />

            <button className='w-[199px] h-[53px] bg-[#0f0b54] hover:bg-[#577DBC] not-italic font-[400px] text-[20px] leading-[23px] text-white rounded-md font-semibold'>SUBMIT</button>
